...
- 自动跟随系统首选语言，并支持在简体中文、繁体中文、英语、日语和韩语之间手动切换
- macOS 可分别隐藏 Dock、应用切换器和菜单栏图标，同时保持后台注入
...
- **切换语言**：在“关于与更新”中选择语言；默认“自动检测”，也可以固定为简体中文、繁体中文、英语、日语或韩语
- **临时恢复原始界面**：在概览页关闭“启用界面增强”，无需退出 Codex
- **macOS 后台运行**：在概览页按需开启“隐藏 Dock 图标”和“隐藏菜单栏图标”；隐藏全部入口后可从“应用程序”重新打开 Codex Tweaks 以恢复窗口，启动顺序与限制参见 [macOS 应用入口显示](docs/macos-app-visibility.md)
