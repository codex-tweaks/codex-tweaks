...
func presentationTextZhCN() map[string]string {
	return map[string]string{
		...
		"overview.agentMode":                          "macOS Agent 模式",
		"overview.agentModeDetail":                    "作为后台辅助应用运行，隐藏 Dock 与 App 切换器中的图标。重新打开 Codex Tweaks 可唤回主窗口。",
		"overview.agentModeHideMenuBar":               "隐藏菜单栏图标",
		"overview.agentModeHideMenuBarDetail":         "隐藏后仍会继续后台注入；可从“应用程序”重新打开 Codex Tweaks 以恢复窗口。",
		...
		"packages.developerAllowUnknownNode":          "自动执行未知 Node 包（仅本次运行）",
		"packages.developerAllowUnknownNodeDetail":    "仅在开发者模式中可用；软件重启后始终恢复关闭。",
		"packages.nodeAuthorizationTitle":             "允许此功能包执行 Node 代码？",
		"packages.nodeAuthorizationWarning":           "Node 代码将以你的当前用户身份运行，可读取和修改文件、访问网络、启动进程，并可能在安装依赖时执行 npm 脚本。仅在信任作者和下方用途说明时允许。",
		"packages.nodeAuthorizationReason":            "作者说明",
		"packages.nodeAuthorizationAllow":             "允许当前版本",
		"packages.nodeAuthorizationCancel":            "取消",
		"packages.nodeAutomaticWarningTitle":          "自动执行未知 Node 包？",
		"packages.nodeAutomaticWarning":               "开启后，本次运行中所有已启用且尚未单独授权的 Node 包都可立即以当前用户身份执行本地代码，包括完整文件、网络、进程权限以及 npm 安装脚本。此选项不会保存，重启软件后自动关闭。",
		"packages.nodeAutomaticWarningAllow":          "仅本次运行允许",
		...
		"packages.status.nodeAuthorizationRequired":   "Node 待授权",
		...
		"packages.detail.nodeAuthorizationRequired":   "整个功能包已被阻止；查看作者说明并授权当前版本后才会运行。",
